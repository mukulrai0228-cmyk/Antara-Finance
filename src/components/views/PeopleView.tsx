    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200/80 rounded-3xl p-5 shadow-sm space-y-4">
          ...
          {/* Filter tabs */}
          <div className="flex flex-wrap gap-1.5 p-1 bg-slate-100 rounded-2xl border border-slate-200/40 w-fit">
            {([
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200/80 rounded-3xl p-5 shadow-sm space-y-3.5">
            ...
            <form onSubmit={handleAddPerson} className="space-y-2.5">
              ...
              <button
                type="submit"
                className="w-full py-2 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl text-xs transition-all shadow-sm flex items-center justify-center gap-1.5"
              >
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xl max-w-lg w-full max-h-[85vh] overflow-y-auto p-6 animate-slide-up relative">
            ...
            <div className="pt-4 border-t border-slate-100 mt-6 flex justify-between items-center">
              <button
                ...
                className="p-2 border border-red-100 hover:bg-red-50 text-red-500 rounded-xl transition-all"
              ...
              <button
                onClick={() => setSelectedPerson(null)}
                className="px-5 py-2 bg-slate-100 hover:bg-slate-200 rounded-xl text-xs font-bold text-slate-700 transition-all"
              >
                Close
              </button>
            </div>
